 ...
 * to work with your app, you must first go to:1
...
public class LoginActivity extends PlusBaseActivity implements
	...
	private static final String[] DUMMY_CREDENTIALS = new String[] {
			"diogene@example.com:diogene",
			"marialuisa@example.com:marialuisa" };
	...
	private boolean isPasswordValid(String password) {
		...
		return hasNumbers && hasLowerCase && hasUpperCase && hasMinLength;
	}
